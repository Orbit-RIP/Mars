//package rip.bridge.practice.tournament.menu.button;
//
//import com.google.common.base.Preconditions;
//import com.google.common.collect.ImmutableList;
//import rip.bridge.practice.kittype.KitType;
//import rip.bridge.practice.tournament.TournamentHandler;
//import rip.bridge.practice.tournament.menu.TournamentParameterMenu;
...
//
//        description.add("");
//        description.add(ChatColor.YELLOW + "Click here to select " + ChatColor.YELLOW + kitType.getDisplayName() + " as the kit for the " + ChatColor.GOLD + ChatColor.BOLD.toString() + "tournament" + ChatColor.YELLOW + ".");
//
//        return description;
//    }
//
