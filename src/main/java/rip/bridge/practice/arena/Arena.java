package rip.bridge.practice.arena;
...
import rip.bridge.practice.util.AngleUtils;
 ...
 * See {@link rip.bridge.practice.arena} for a comparision of
...
public final class Arena {
    ...
    public void restore() {
        synchronized (chunkSnapshots) {
            World world = bounds.getWorld();
            chunkSnapshots.entrySet().forEach(entry -> world.getChunkAt(LongHash.msw(entry.getKey()), LongHash.lsw(entry.getKey())).restoreSnapshot((rip.bridge.ChunkSnapshot) entry.getValue()));
