...
import rip.orbit.mars.queue.listener.QueueGeneralListener;
import rip.orbit.mars.queue.listener.QueueItemListener;
...
public final class QueueHandler {
    ...
    public QueueHandler() {
        Bukkit.getPluginManager().registerEvents(new QueueGeneralListener(this), Mars.getInstance());
        Bukkit.getPluginManager().registerEvents(new QueueItemListener(this), Mars.getInstance());
