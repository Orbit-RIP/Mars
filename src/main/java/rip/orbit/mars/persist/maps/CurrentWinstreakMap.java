 ...
 * 14/08/2021 / 5:38 AM
 * HCTeams / rip.orbit.mars.persist.maps
 */
public class CurrentWinstreakMap extends PersistMap<Integer> {

	public CurrentWinstreakMap() {
		setKeyPrefix("CurrentWinstreak");
		setMongoName("CurrentWinstreaks");
	}
