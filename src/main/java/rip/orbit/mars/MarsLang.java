...
import rip.orbit.mars.command.HelpCommand;
import rip.orbit.mars.lobby.LobbyItems;
import rip.orbit.mars.party.command.PartyHelpCommand;
...
public final class MarsLang {
     ...
     * @see rip.orbit.mars.party.command
     */
