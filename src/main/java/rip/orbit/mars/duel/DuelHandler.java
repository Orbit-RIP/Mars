...
import rip.orbit.mars.duel.listener.DuelListener;
...
public final class DuelHandler {
    ...
    public DuelHandler() {
        Bukkit.getPluginManager().registerEvents(new DuelListener(), Mars.getInstance());
        Bukkit.getScheduler().runTaskTimerAsynchronously(Mars.getInstance(), () -> activeInvites.removeIf(DuelInvite::isExpired), 20, 20);
    }
