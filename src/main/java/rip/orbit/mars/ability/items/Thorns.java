...
public class Thorns extends Ability {
	...
	public String displayName() {
		return CC.translate("&e&lThorns Ability");
	}
		...
		if (event.getAction().name().contains("RIGHT")) {
			if (isSimilar(event.getItem())) {
				...
				List<String> hitMsg = Arrays.asList(
						...
						" ",
						"&6&l┃ &e" + target.getName() + "&f will now be damaged",
						"&6&l┃ &fanytime they hit a player for &e12 seconds&f.",
						"");
				...
				List<String> beenHitMsg = Arrays.asList(
						...
						" ",
						"&6&l┃ &eYou" + "&f will now be damaged anytime",
						"&6&l┃ &fyou hit a player for &e12 seconds&f.",
						"");
				...
				}.runTaskLater(Mars.getInstance(), 20 * 12);
