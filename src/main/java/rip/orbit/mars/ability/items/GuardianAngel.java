...
public class GuardianAngel extends Ability {
	...
	public String displayName() {
		return CC.translate("&5&lGuardian Angel");
	}
	...
	public void onGuardianAngel(PlayerInteractEvent event) {
		...
		if (isSimilar(event.getItem())) {
			...
			List<String> hitMsg = Arrays.asList(
					...
					" ",
					"&6&l┃ &fYou have &515 seconds&f to get below 2 hearts.",
					"&6&l┃ &fIf this does happen you will be granted full",
					"&6&l┃ &fhealth.",
					"");
			...
			if (gAngel.contains(damaged.getUniqueId())) {
				...
				if (health <= 2.0) {
					...
					List<String> hitMsg = Arrays.asList(
							...
							" ",
							"&6&l┃ &fYou now have &5full&f health.",
							"");
