	...
	public void onDome(BlockPlaceEvent event) {
		...
		if (isSimilar(event.getItemInHand())) {
			...
			List<String> hitMsg = Arrays.asList(
					...
					" ",
					"&6&l┃ &fAnyone within &33 blocks&f of where",
					"&6&l┃ &fyou placed this, now has &3antibuild",
					"&6&l┃ &3effects, antiability effects, and",
					"&6&l┃ &3blindness&f for &315 seconds&f.",
					" ",
					"&3&lAffected Players"
			);
			...
			names.forEach(s -> {
				player.sendMessage(CC.translate("&6&l┃ &f" + s.getName()));
