...
import rip.orbit.mars.elo.listener.EloLoadListener;
import rip.orbit.mars.elo.listener.EloUpdateListener;
import rip.orbit.mars.elo.repository.EloRepository;
import rip.orbit.mars.elo.repository.MongoEloRepository;
...
public final class EloHandler {
    ...
    public EloHandler() {
        Bukkit.getPluginManager().registerEvents(new EloLoadListener(this), Mars.getInstance());
