...
import rip.orbit.mars.pvpclasses.PvPClasses;
...
public final class Party {
     ...
     * New UUID = new Party
     */
    @Getter private final UUID partyId = new UUID(Proton.RANDOM.nextLong(), Proton.RANDOM.nextLong());
     ...
     * player provided
     * @Parameter target player who must match the result's {@link PartyInvite#getTarget()}
    ...
    public void invite(Player target) {
        ...
        invites.add(invite);
        Bukkit.getScheduler().runTaskLater(Mars.getInstance(), () -> invites.remove(invite), PartyHandler.INVITE_EXPIRATION_SECONDS * 20);
    }
    ...
    public void join(Player player) {
        ...
        Mars.getInstance().getPartyHandler().updatePartyCache(player.getUniqueId(), this);
    ...
    public void leave(Player player) {
        ...
        Mars.getInstance().getPartyHandler().updatePartyCache(player.getUniqueId(), null);
        ...
        if (leader.equals(player.getUniqueId())) {
            ...
            Player newLeader = Bukkit.getPlayer(membersArray[Proton.RANDOM.nextInt(membersArray.length)]);
    ...
    public void disband() {
        ...
        Mars.getInstance().getPartyHandler().unregisterParty(this);
     ...
     * @Parameter pitch the pitch to play the provided sound at
     */
    ...
    public void resetInventoriesDelayed() {
        ...
        Bukkit.getScheduler().runTaskLater(Mars.getInstance(), this::resetInventoriesNow, InventoryUtils.RESET_DELAY_TICKS);
    }
